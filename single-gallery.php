...
if ( post_password_required() ) :
	...
	<div class="demo-gallery">
		<div id="container" class="list-unstyled row mycontainer"
				...
				while ( $loop->have_posts() ) :
					...
					if ( get_post_gallery() ) {
						...
						foreach ( $pieces as $key => $value ) {
							...
							data-responsive="<?php echo $image_medium[0]; ?> 375, <?php echo $image_medium[0]; ?> 480,
							<?php echo $image_medium[0]; ?> 800" data-src="<?php echo $image_full[0]; ?>"
